...
const CoffeeCard = () => {
    ...
    return (
        <div className={["flex flex-col items-center justify-start rounded-lg shadow-xl h-100 w-64 p-4", hoveredBackgroundColor].join(' ')}>
            ...
            <button onClick={() => setIsHovered(!isHovered)} onMouseEnter={() => setIsHovered(true)}
